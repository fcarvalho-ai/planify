...
## Version candidate V1 — 0.5.0-rc2

Le développement V1 suit l'ordre et le backlog placés dans `docs/specifications/`. Les gates G0 à G8 ainsi que les parcours Integration/E2E sont franchis. Le candidat `0.5.0-rc2` ajoute aux réalisations et au moteur Finance six dashboards adaptés aux rôles, des KPI réconciliables, les exports Planning/KPI Excel et PDF et une API Analytics/BI locale. La RC2 corrige aussi les tokens visuels partagés par Pilotage, Réalisations et Finance ainsi que le contraste du focus clavier. Les coûts et marges restent protégés de bout en bout ; les surfaces authentifiées échouent fermées après déconnexion ou expiration de session. Le détail des preuves, limites P2 et empreintes est conservé dans `docs/project-status.md` et les rapports indépendants `docs/code-review.md`, `docs/qa-report.md`, `docs/security-review.md`, `docs/performance-report.md`, `docs/integration-report.md` et `docs/e2e-report.md`.
